...
from .permutation_utils import transposition, permutation_from_cycles, permutations_with_cycle_lenghts
...
class PermutationGroups:
    ...
    def conjugacy_class(n: int, classes: list[list[int]]) -> CayleyGraphDef:
        ...
        Example: cycle_lengths = [[2,2],[3]] generates all permutations with two 2-cycles and one 3-cycle.
        """
