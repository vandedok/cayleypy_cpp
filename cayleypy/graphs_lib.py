...
class PermutationGroups:
    ...
    def conjugacy_class(n: int, classes: dict[tuple[int], int | None]) -> CayleyGraphDef:
        ...
        Cayley graph for S_n is generated by permutations from the conjugacy classes
        specified cycle lenghts - keys of parameter `classes`.

        If classes[cycle_lengths] is None, all permutations from this class are taken as generators.
        Otherwise, if classes[cycle_lengths] = k, sample k random generators from this class.
